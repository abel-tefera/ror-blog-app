...
> A blog app built on top of the Ruby on Rails framework
...
- On the terminal run this command git clone https://github.com/abel-tefera/ror-blog-app.git
...
```sh
git clone https://github.com/abel-tefera/ror-blog-app.git
```
